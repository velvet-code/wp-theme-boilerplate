...
function boilerplate_scripts() {
	wp_enqueue_style( 'boilerplate-style', get_theme_file_uri( 'dist/app.css' ), filemtime( get_theme_file_path( 'dist/app.css' ) ), 'screen' );
	wp_enqueue_script( 'boilerplate-script', get_theme_file_uri( 'dist/app.js' ), array(), filemtime( get_theme_file_path( 'dist/app.js' ) ), true );
}
